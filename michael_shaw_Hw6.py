...
def urlGetFileFull():
    ...
    """
    with urlopen("http://icarus.cs.weber.edu/~hvalle/cs3030/data/error.log.full") as error:
...
if __name__ == "__main__":
    ...
    parser.add_argument("RunFileFull", help="Help")
    args = parser.parse_args()

    if args.RunFileFull == "RunFileFull":
        main()
    ...
    if args.RunFileFull == "" or args.RunFile == "":
        print ("Usage: michael_shaw_Hw6.py FileName or FileNameFull")
